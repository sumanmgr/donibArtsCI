                    ...
                    <div class="side-menu-container">
                        <div class="navbar-header">
                            <a class="navbar-brand" href="#">
                                ...
                                <div class="title">Donib Arts V.2</div>
                            </a>
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li>
                                <a href="<?php echo site_url('admin/bookings'); ?>">
                                    <span class="icon fa fa-paperclip"></span><span class="title">Bookings</span>
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo site_url('admin/pages'); ?>">
                                    <span class="icon fa fa-files-o"></span><span class="title">Pages</span>
                                </a>
                            </li>
                            <?php /*<li>
                                <a href="<?php echo site_url('admin/users'); ?>">
